...
class Program
{
    ...
    {
        Animal dog = new Dog("Собака", LivePlace.PetOwner);
        Animal owl = new Owl("Сова", LivePlace.Nature);
        Animal lizard = new Lizard("Ящірка", LivePlace.ZooShop);

        dog.StatusChanged += DisplayStatus;
        owl.StatusChanged += DisplayStatus;
        lizard.StatusChanged += DisplayStatus;
    ...
    static void CreateAnimal()
    {
        ...
        LivePlace place = envChoice switch
        {
            "1" => LivePlace.PetOwner,
            "2" => LivePlace.ZooShop,
            "3" => LivePlace.Nature,
        ...
        {
            "1" => new Dog(name, place),
            "2" => new Owl(name, place),
            "3" => new Lizard(name, place),
            _ => new Dog(name, place)
        };

        animal.StatusChanged += DisplayStatus;
    ...
    static void FeedAll()
    {
        Console.WriteLine("Годування всіх тварин");
        _owner.FeedAll();
    }
    ...
    static void FeedSingleAnimal()
    {
        ...
        {
            Animal a = _owner.Animals[i];
            Console.WriteLine($"{i + 1}. {a.Name} ({a.GetType().Name}) | Їв сьогодні: {a.MealsToday}");
        }
    ...
    static void MoveAll()
    {
        Console.WriteLine("Рух всіх тварин");
        _owner.MoveAll();
    }

    static void CleanAll()
    {
        Console.WriteLine("Прибирання та щастя");
        _owner.CleanAll();
    }
    ...
    static void DisplayStatus(Animal animal, string message)
    {
